  ...
  return (
    <section className="bg-white py-20 px-5 lg:px-32 xl:px-40">
      <div className="flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="max-w-[650px] lg:w-1/2 flex flex-col gap-6">
          <span className="text-[#1E3D69] bg-[#A9D6EB] px-4 py-2 text-[18px] font-medium uppercase tracking-wide rounded w-fit ">
            Our History
          </span>
