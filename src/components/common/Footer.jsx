...
const Footer = () => {
  return (
    <section className="w-full bg-white border-t border-gray-200 ">
      ...
      {/* Bottom Bar */}
      <div className="px-5 lg:px-32 xl:px-40 border-t border-gray-200 py-6 bg-[#F5F5F5] flex flex-col lg:flex-row justify-between items-center text-center text-[16px] font-normal gap-2">
        <p>
